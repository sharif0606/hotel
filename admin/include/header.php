...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="<?= $base_url?>../assets/img/main_logo.jpg">
	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="index.php" class="logo"> <img src="<?= $base_url?>../assets/img/main_logo.jpg" width="70" height="100" alt="logo"> <span class="logoclass">SUNRISE HOTEL</span> </a>
				<!-- <a href="index.html" class="logo logo-small"> <img src="<?= $base_url?>../assets/img/hotel_logo.png" alt="Logo" width="100" height="30"> </a> -->
			</div>
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="<?= $base_url?>/../assets/img/profiles/me(1).jpg" width="31" alt="Thouhid"></span> </a>
					<div class="dropdown-menu">
						...
						</div> <a class="dropdown-item" href="profile.html">My Profile</a> <a class="dropdown-item" href="settings.html">Account Settings</a> <a class="dropdown-item" href="logout.php">Logout</a> </div>
				</li>
			</ul>
