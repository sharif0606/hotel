		...
		<div class="row">
			<div class="col-sm-12">
				...
				<?php
					...
					WHERE tbl_reservation.deleted_at is null and tbl_reservation.status !=2");
					if($rs['data']){
				...
				<tr>
					...
					<td><?= $d->check_out ?></td>
					<td >
						<a class='btn btn-primary' href="<?= $base_url ?>bill_create.php?id=<?= $d->id ?>">BILL</a>
					</td>
					
					<td class="text-right">
						<a href="<?= $base_url ?>reservation_edit.php?id=<?= $d->id ?>"><i class="fa fa-edit"></i></a>
					</td>
